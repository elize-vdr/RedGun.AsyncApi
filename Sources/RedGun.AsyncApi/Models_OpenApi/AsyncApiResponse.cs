...
namespace RedGun.AsyncApi.Models
{
    ...
    public class AsyncApiResponse : IAsyncApiSerializable, IAsyncApiReferenceable, IAsyncApiExtensible
    {
        ...
        public void SerializeAsV3WithoutReference(IAsyncApiWriter writer)
        {
            ...
            // extension
            writer.WriteExtensions(Extensions, AsyncApiSpecVersion.AsyncApi3_0);
        ...
        public void SerializeAsV2WithoutReference(IAsyncApiWriter writer)
        {
            ...
            if (Content != null)
            {
                ...
                if (mediatype.Value != null)
                {
                    ...
                    writer.WriteExtensions(mediatype.Value.Extensions, AsyncApiSpecVersion.AsyncApi2_0);
            ...
            // extension
            writer.WriteExtensions(extensionsClone, AsyncApiSpecVersion.AsyncApi2_0);
