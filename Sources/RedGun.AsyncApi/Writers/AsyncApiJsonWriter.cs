...
namespace RedGun.AsyncApi.Writers
{
    ...
    public class AsyncApiJsonWriter : AsyncApiWriterBase
    {
        ...
        public AsyncApiJsonWriter(TextWriter textWriter) : base(textWriter, null)
        {
        }
        ...
        public AsyncApiJsonWriter(TextWriter textWriter, AsyncApiWriterSettings settings) : base(textWriter, settings)
        {
        }
