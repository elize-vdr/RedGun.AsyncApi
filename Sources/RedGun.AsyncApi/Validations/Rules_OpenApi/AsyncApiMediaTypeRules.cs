...
{
    /// <summary>
    /// The validation rules for <see cref="AsyncApiMediaType"/>.
    /// </summary>
    /// <remarks>
    /// Removed this in v1.3 as a default rule as the AsyncAPI specification does not require that example
    ...
    public static class AsyncApiMediaTypeRules
    {
        ...
        /// </summary>
        public static ValidationRule<AsyncApiMediaType> MediaTypeMismatchedDataType =>
            new ValidationRule<AsyncApiMediaType>(
                (context, mediaType) =>
                {
                    // example
