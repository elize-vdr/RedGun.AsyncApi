...
namespace RedGun.AsyncApi.Tests.Writers
{
    ...
    public class AsyncApiWriterSpecialCharacterTests
    {
        private readonly ITestOutputHelper _output;

        public AsyncApiWriterSpecialCharacterTests(ITestOutputHelper output)
        {
            _output = output;
        }
        ...
        public void WriteStringWithNewlineCharactersInObjectAsYamlWorks(string input, string expected)
        {
            // Arrange
            var outputStringWriter = new StringWriter(CultureInfo.InvariantCulture);
            var writer = new AsyncApiYamlWriter(outputStringWriter) { UseLiteralStyle = true, };
