...
namespace RedGun.AsyncApi.Tests.PublicApi
{
    ...
    public class PublicApiTests
    {
        ...
        public void ReviewPublicApiChanges()
        {
            ...
            // Arrange
            var publicApi = typeof(AsyncApiSpecVersion).Assembly.GeneratePublicApi(new ApiGeneratorOptions() { WhitelistedNamespacePrefixes = new[] { "RedGun.AsyncApi" } } );
